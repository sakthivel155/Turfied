...
function Navbar() {
    return (
        <header className="sticky top-0 z-[20] bg-white tablet:shadow-lg">
            <div className="flex justify-between items-center px-4 py-4 laptop:max-w-[90%] laptop:mx-auto">
                ...
                <nav className="fixed flex z-20 bottom-0 left-0 w-full justify-between text-center bg-white shadow-lg rounded-t-2xl tablet:flex tablet:relative tablet:top-0 tablet:rounded-none tablet:shadow-none">
                    <ul className="flex items-center justify-between font-bold px-5 py-2 w-full tablet:justify-center tablet:p-0 tablet:gap-5">
                        <li className='tablet:ml-auto'><Link to={'/'} className='flex flex-col items-center tablet:flex-row tablet:gap-1'> <img src={homeIcon} alt='' className='w-6'/>Home</Link></li>
                        <li><Link to={'/Play'} className='flex flex-col items-center tablet:flex-row tablet:gap-1'><img src={playIcon} alt='' className='w-6'/>Play</Link></li>
                        <li><Link to={'/Book'} className='flex flex-col items-center tablet:flex-row tablet:gap-1'><img src={bookIcon} alt='' className='w-6'/>Book</Link></li>
                        <li><Link to={'/Learn'} className='flex flex-col items-center tablet:flex-row tablet:gap-1'><img src={learnIcon} alt='' className='w-6'/>Learn</Link></li>
                        <li className="tablet:ml-auto">
                            <Link to={'/Login'} className='flex flex-col items-center tablet:flex-row tablet:gap-1'>
